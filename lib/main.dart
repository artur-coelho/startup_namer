...
class _RandomWordsState extends State<RandomWords> {
  ...
  Widget _buildSuggestions() {
    ...
    /* 1 - The itemBuilder callback is called once per suggested word pairing,
         ...
         function adds a ListTitle row for the word Pairing. For odd rows, the
     ...
     3 - The expression i ~/ 2 divides i by 2 and returns an integer result. For
         example: 1, 2, 3, 4, 5 becomes 0, 1, 1, 2, 2. This calculates the actual
